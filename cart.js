...
function generateCartItems(cartItems) {
    ...
    cartItems.forEach((item) => {
        ...
        <div class="cart-item flex items-center pb-4 border-b border-gray-100">
            <div class="cart-item-image bg-white w-40 h-24 bg-white p-4 rounded-lg">
            ...
            <div class="cart-item-counter w-48 flex items-center">
                <div data-id="${item.id}"
                    class="cart-items-decrease cursor-pointer text-gray-400 bg-gray-100 rounded h-6 w-6 flex justify-center items-center hover:bg-gray-200 mr-2">
                    <i class="fas fa-chevron-left fa-xs"></i>
                </div>
                <h4 class="text-gray-400 ">x ${item.quantity}</h4>
                <div data-id="${item.id}"
                    class="cart-items-increase cursor-pointer text-gray-400 bg-gray-100 rounded h-6 w-6 flex justify-center items-center hover:bg-gray-200 ml-2">
            ...
            <div data-id="${item.id}" class="cart-item-delete cursor-pointer w-10 font-bold text-gray-300 hover:text-gray-400">
